...
urlpatterns = [
    ...
    path('comments/<int:post_id>/', CommentManagmentAPIView.as_view(), name="post-comments"),
    path('comments/delete/<int:comment_id>/', CommentManagmentAPIView.as_view(), name="comment-delete"),
